...
HttpRequest::HttpRequest(): {} /*_request((std::string &) "")*/
HttpRequest::HttpRequest(std::string & request): _request(request) {}
HttpRequest::HttpRequest(HttpRequest & instance): _request(instance._request), _headers(instance._headers) {}
